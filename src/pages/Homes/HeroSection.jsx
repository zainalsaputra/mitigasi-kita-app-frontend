  ...
  return (
    <>
      ...
      >
        ...
        <div className="grid-center grid-cols-3 gap-8 h-full py-10">
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 text-center px-7">
            {/* Item 1 */}
            <Link
              to="/map"
              className="flex flex-col items-center space-y-2 w-48 sm:w-56 md:w-64 hover:scale-105 transition-transform duration-300 relative z-20"
            >
